...
const { invitedMemberConfirmationTeam } = lang;
        ...
        <div className="w-full sm:w-96 flex flex-col items-center">
          <div className="items-center text-center">
            <Typography variant='body-sm' classes="text-white px-14 font-medium">
              {invitedMemberConfirmationTeam.header}
            </Typography>
            <Typography variant="heading-md" classes="font-semibold text-white mt-2 text-3xl">
              {`Congrats ${session?.user?.firstName || invitedMemberConfirmationTeam.firstName}!`}
            </Typography>
          </div>
          <div className="items-center">
            <Typography variant="span-sm" classes="text-white font-medium">
              {invitedMemberConfirmationTeam.message}
            </Typography>
            <div className='mt-20'>
              <Button
                variant='solid'
                ...
                width='w-full'
                type='button'
                data-cy='confirmation-team-button'
              ...
              >
                {invitedMemberConfirmationTeam.buttonText}
              </Button>
            </div>
          </div>
        </div>
...
export default InvitedMemberConfirmationTeam;
