...
const {
  addTeamMemberUrlFE, chooseCategoriesFE,
} = team;
...
const ChooseCategories = () => {
  ...
  return (
    <ContentLayout>
      <form className="flex flex-col md:flex-row py-3 lg:px-[80px] lg:py-[48px] xl:px-[80px] xl:py-[48px] mt-0 lg:mt-[7vh] items-center" onSubmit={handleSubmit(onSubmit)}>
        <div className="w-full md:w-2/3">
          ...
          <Typography variant="body-sm" classes="font-medium text-grey-700 mt-3 text-center lg:text-left xl:text-left w-full lg:w-[52%] mb-10">
          ...
          <div className="flex flex-wrap w-full lg:w-1/2 overflow-y-auto max-h-[40vh] pb-[50%] mdsm:pb-[10%] md:pb-0">
            ...
            {categories.map((category:any, index:number) => (
              <div key={index} className="w-1/2 lg:w-1/3 p-1.5 pl-0 pr-3 items-start">
                <Button
            ...
            <div className="flex justify-between items-center">
              <div className="flex-shrink mr-2">
                <div className="mt-3 lg:mt-8">
                  <Typography variant="body-md" classes="text-base font-bold text-grey-900 pl-2 mt-2.5">
                    {individualChooseCategories.total}
                    <span className="font-bold">£{userPrice + price}/month</span>
            ...
            <div className="mt-6 flex-none lg:flex-grow block lg:hidden">
              <div className="flex justify-between items-center">
                <Button
                  ...
                  onClick={() => router.push('/team/add-team-member')}
                >
                  {individualChooseCategories.backButton}
                </Button>
                <Button
